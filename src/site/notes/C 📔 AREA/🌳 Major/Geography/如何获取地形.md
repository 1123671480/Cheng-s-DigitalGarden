---
{"dg-publish":true,"permalink":"/C 📔 AREA/🌳 Major/Geography/如何获取地形/","tags":["TBP"],"noteIcon":"withered","created":"2024-11-03T17:43:01.746+08:00","updated":"2024-12-24T10:21:02.152+08:00"}
---
...
「文件」-「导出选取的物件」导出为 SKP 文件到 [[C 📔 AREA/⚒️ Software/Model/SketchUp\|SketchUp]]
**有高程点的 CAD 文件生成地形**
...
可导入 [[C 📔 AREA/⚒️ Software/Model/SketchUp\|SketchUp]]导入 [[C 📔 AREA/⚒️ Software/Autodesk/AutoCAD_TArch\|AutoCAD_TArch]]，「TYBG」统一标高，导入 [[C 📔 AREA/⚒️ Software/Rhinoceros 3D/Rhino\|Rhino]]
打开 [[C 📔 AREA/⚒️ Software/Rhinoceros 3D/Grasshopper\|Grasshopper]]，「File」-「Special Folders」-「Components Folders」，把「Hoster Reference. Gha」复制到这个文件夹 （付费课程资料）
「高程数字转地形」电池包拖入 [[C 📔 AREA/⚒️ Software/Rhinoceros 3D/Grasshopper\|Grasshopper]] 内。启动电池包，鼠标中键点击「Suface」-「Bake」
框选-「Patch」
取样点间距「1」控制点数
